 ...
 */
package com.aritu.eloraplm.checkin.services;
...
public class CheckinService implements CheckinManager {
    ...
    public DocumentModel checkinDocument(DocumentModel doc,
        ...
        /*
         * ViewerPdfUpdater.createViewer(doc,
    ...
    private void updateAndOverwriteViewer(DocumentModel doc)
            throws EloraException {
        ViewerPdfUpdater.createViewer(doc,
                ViewerActionConstants.ACTION_CHECK_IN);
        overwriteViewerProperty(doc);
    }

    private void overwriteViewerProperty(DocumentModel doc)
            throws EloraException {
