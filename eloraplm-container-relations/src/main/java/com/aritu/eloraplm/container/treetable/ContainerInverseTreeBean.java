package com.aritu.eloraplm.container.treetable;
...
@Name("containerInverseTreeBean")
@Scope(ScopeType.CONVERSATION)
@Install(precedence = APPLICATION)
@AutomaticDocumentBasedInvalidation
public class ContainerInverseTreeBean extends EditableRelationTreeBean
        implements Serializable {
    private static final long serialVersionUID = 1L;

    private static final Log log = LogFactory.getLog(
            ContainerInverseTreeBean.class);
    ...
    public ContainerInverseTreeBean() throws EloraException {
    ...
    @Override
    @Factory(value = "containerInverseRoot", scope = ScopeType.EVENT)
