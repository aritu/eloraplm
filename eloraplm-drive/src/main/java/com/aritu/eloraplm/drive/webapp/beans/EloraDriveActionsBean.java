...
public class EloraDriveActionsBean extends InputController implements Serializable {

    private static final long serialVersionUID = 1L;

    private static final Log log = LogFactory.getLog(EloraDriveActionsBean.class);
    ...
    private static final String ELORA_DRIVE_VERSION = "4.5.1";

    private static final String DESKTOP_PACKAGE_APPIMAGE = "nuxeo-drive-"
            + ELORA_DRIVE_VERSION + "-x86_64.AppImage";

    private static final String DESKTOP_PACKAGE_PREFIX = "nuxeo-drive-"
            + ELORA_DRIVE_VERSION + ".";

    private static final String MSI_EXTENSION = "exe";
    ...
    @Factory(value = "eloraDriveClientPackages", scope = ScopeType.CONVERSATION)
