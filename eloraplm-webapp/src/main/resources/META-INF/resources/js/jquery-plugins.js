...
(function(a) {
    ...
    (function() {
        ...
        y.position = {
            scrollbarWidth: function() {
                ...
                var ab, aa, ad = y("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),
                    ac = ad.children()[0];
                y("body").append(ad);
                ab = ac.offsetWidth;
        ...
        y.fn.position = function(ak) {
            ...
            ak = y.extend({}, ak);
            var al, ah, af, aj, ae, aa, ag = y(ak.of),
                ad = y.position.getWithinInfo(ak.within),
                ab = y.position.getScrollInfo(ad),
                ai = (ak.collision || "flip").split(" "),
                ac = {};
            aa = P(ag);
            ...
            return this.each(function() {
                var an, ax, ap = y(this),
                    ar = ap.outerWidth(),
                    ao = ap.outerHeight(),
                    aq = S(this, "marginLeft"),
                    am = S(this, "marginTop"),
                    aw = ar + aq + S(this, "marginRight") + ab.width,
                    av = ao + am + S(this, "marginBottom") + ab.height,
                    at = y.extend({}, ae),
                    au = Y(ac.my, ap.outerWidth(), ap.outerHeight());
                if (ak.my[0] === "right") {
                    at.left -= ar
                } else {
                    if (ak.my[0] === "center") {
        ...
        y.ui.position = {
            fit: {
                left: function(ae, ad) {
                    var ac = ad.within,
                        ag = ac.isWindow ? ac.scrollLeft : ac.offset.left,
                        ai = ac.width,
                        af = ae.left - ad.collisionPosition.marginLeft,
                        ah = ag - af,
                        ab = af + ad.collisionWidth - ai - ag,
                        aa;
                ...
                top: function(ad, ac) {
                    var ab = ac.within,
                        ah = ab.isWindow ? ab.scrollTop : ab.offset.top,
                        ai = ac.within.height,
                        af = ad.top - ac.collisionPosition.marginTop,
                        ag = ah - af,
                        ae = af + ac.collisionHeight - ai - ah,
                        aa;
            ...
            flip: {
                left: function(ag, af) {
                    var ae = af.within,
                        ak = ae.offset.left + ae.scrollLeft,
                        an = ae.width,
                        ac = ae.isWindow ? ae.scrollLeft : ae.offset.left,
                        ah = ag.left - af.collisionPosition.marginLeft,
                        al = ah - ac,
                        ab = ah + af.collisionWidth - an - ac,
                        aj = af.my[0] === "left" ? -af.elemWidth : af.my[0] === "right" ? af.elemWidth : 0,
                        am = af.at[0] === "left" ? af.targetWidth : af.at[0] === "right" ? -af.targetWidth : 0,
                        ad = -2 * af.offset[0],
                        aa, ai;
                    if (al < 0) {
                ...
                top: function(af, ae) {
                    var ad = ae.within,
                        am = ad.offset.top + ad.scrollTop,
                        an = ad.height,
                        aa = ad.isWindow ? ad.scrollTop : ad.offset.top,
                        ah = af.top - ae.collisionPosition.marginTop,
                        aj = ah - aa,
                        ag = ah + ae.collisionHeight - an - aa,
                        ak = ae.my[1] === "top",
                        ai = ak ? -ae.elemHeight : ae.my[1] === "bottom" ? ae.elemHeight : 0,
                        ao = ae.at[1] === "top" ? ae.targetHeight : ae.at[1] === "bottom" ? -ae.targetHeight : 0,
                        ac = -2 * ae.offset[1],
                        al, ab;
                    if (aj < 0) {
        ...
        (function() {
            var ae, ag, ab, ad, ac, aa = document.getElementsByTagName("body")[0],
    ...
    y.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(Y, V, P) {
            var M, ad, R, S, X, U, T, ae, Z, Q, W = P.options,
                ac = W.snapTolerance,
                ab = V.offset.left,
                aa = ab + P.helperProportions.width,
                O = V.offset.top,
                N = O + P.helperProportions.height;
    ...
    y.ui.plugin.add("draggable", "stack", {
        start: function(O, P, M) {
            var N, R = M.options,
                Q = y.makeArray(y(R.stack)).sort(function(T, S) {
    ...
    y.ui.intersect = (function() {
        ...
        return function(Z, T, X) {
            ...
            var R, S, P = (Z.positionAbs || Z.position.absolute).left,
                W = (Z.positionAbs || Z.position.absolute).top,
                O = P + Z.helperProportions.width,
                V = W + Z.helperProportions.height,
                Q = T.offset.left,
                Y = T.offset.top,
                N = Q + T.proportions().width,
                U = Y + T.proportions().height;
            switch (X) {
                case "fit":
    ...
    y.ui.ddmanager = {
        ...
        prepareOffsets: function(P, R) {
            var O, N, M = y.ui.ddmanager.droppables[P.options.scope] || [],
                Q = R ? R.type : null,
                S = (P.currentItem || P.element).find(":data(ui-droppable)").addBack();
        ...
        drag: function(M, N) {
            ...
            y.each(y.ui.ddmanager.droppables[M.options.scope] || [], function() {
                ...
                var R, P, O, Q = y.ui.intersect(M, this, this.options.tolerance),
                    S = !Q && this.isover ? "isout" : (Q && !this.isover ? "isover" : null);
                if (!S) {
                    return
                }
    ...
    y.widget("ui.resizable", y.ui.mouse, {
        ...
        _mouseStop: function(P) {
            this.resizing = false;
            var O, M, N, S, V, R, U, Q = this.options,
                T = this;
            if (this._helper) {
    ...
    y.ui.plugin.add("resizable", "containment", {
        start: function() {
            var U, O, W, M, T, P, X, V = y(this).resizable("instance"),
                S = V.options,
                R = V.element,
                N = S.containment,
                Q = (N instanceof y) ? N.get(0) : (/parent/.test(N)) ? R.parent().get(0) : N;
            if (!Q) {
                return
            }
        ...
        resize: function(N, X) {
            var T, Z, S, Q, U = y(this).resizable("instance"),
                P = U.options,
                W = U.containerOffset,
                V = U.position,
                Y = U._aspectRatio || N.shiftKey,
                M = {
                    top: 0,
                    left: 0
                },
                O = U.containerElement,
                R = true;
    ...
    var s = y.widget("ui.sortable", y.ui.mouse, {
        ...
        _refreshItems: function(M) {
            ...
            var Q, O, V, R, U, N, X, W, S = this.items,
                P = [
                    [y.isFunction(this.options.items) ? this.options.items.call(this.element[0], M, {
                        item: this.currentItem
        ...
        _contactContainers: function(M) {
            var R, P, V, S, T, X, Y, Q, U, O, N = null,
                W = null;
        ...
        _generatePosition: function(P) {
            var R, Q, S = this.options,
                O = P.pageX,
                N = P.pageY,
                M = this.cssPosition === "absolute" && !(this.scrollParent[0] !== document && y.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent,
                T = (/(html|body)/i).test(M[0].tagName);
    ...
    y.extend(K.prototype, {
        ...
        _attachments: function(O, R) {
            var N, Q, M, S = this._get(R, "appendText"),
                P = this._get(R, "isRTL");
            if (R.append) {
                R.append.remove()
            }
        ...
        _autoSize: function(S) {
            if (this._get(S, "autoSize") && !S.inline) {
                var P, N, O, R, Q = new Date(2009, 12 - 1, 20),
                    M = this._get(S, "dateFormat");
                if (M.match(/[DM]/)) {
                    P = function(T) {
                        N = 0;
                        O = 0;
        ...
        _doKeyDown: function(P) {
            var N, M, R, Q = y.datepicker._getInst(P.target),
                S = true,
                O = Q.dpDiv.is(".ui-datepicker-rtl");
            Q._keyEvent = true;
        ...
        _updateDatepicker: function(O) {
            ...
            var Q, M = this._getNumberOfMonths(O),
                P = M[1],
                N = 17;
        ...
        parseDate: function(ac, X, ae) {
            ...
            var P, Z, N, ad = 0,
                S = (ae ? ae.shortYearCutoff : null) || this._defaults.shortYearCutoff,
                O = (typeof S !== "string" ? S : new Date().getFullYear() % 100 + parseInt(S, 10)),
                V = (ae ? ae.dayNamesShort : null) || this._defaults.dayNamesShort,
                ag = (ae ? ae.dayNames : null) || this._defaults.dayNames,
                M = (ae ? ae.monthNamesShort : null) || this._defaults.monthNamesShort,
                Q = (ae ? ae.monthNames : null) || this._defaults.monthNames,
                R = -1,
                ah = -1,
                ab = -1,
                U = -1,
        ...
        formatDate: function(V, P, Q) {
            ...
            var X, Y = (Q ? Q.dayNamesShort : null) || this._defaults.dayNamesShort,
                N = (Q ? Q.dayNames : null) || this._defaults.dayNames,
                T = (Q ? Q.monthNamesShort : null) || this._defaults.monthNamesShort,
                R = (Q ? Q.monthNames : null) || this._defaults.monthNames,
                W = function(Z) {
        ...
        _generateHTML: function(aD) {
            var af, ae, ay, ap, Q, aH, aB, au, aK, an, aO, X, Z, Y, N, aG, V, ai, aJ, aw, aP, ah, am, W, R, az, ar, av, at, U, ak, aa, aC, aF, P, aI, aM, aq, ab, aE = new Date(),
                ag = this._daylightSavingAdjust(new Date(aE.getFullYear(), aE.getMonth(), aE.getDate())),
                aL = this._get(aD, "isRTL"),
                aN = this._get(aD, "showButtonPanel"),
                ax = this._get(aD, "hideIfNoPrevNext"),
                al = this._get(aD, "navigationAsDateFormat"),
                ac = this._getNumberOfMonths(aD),
                T = this._get(aD, "showCurrentAtPos"),
                ao = this._get(aD, "stepMonths"),
                aj = (ac[0] !== 1 || ac[1] !== 1),
                O = this._daylightSavingAdjust((!aD.currentDay ? new Date(9999, 9, 9) : new Date(aD.currentYear, aD.currentMonth, aD.currentDay))),
                S = this._getMinMaxDate(aD, "min"),
                ad = this._getMinMaxDate(aD, "max"),
                M = aD.drawMonth - T,
                aA = aD.drawYear;
            if (M < 0) {
                M += 12;
        ...
        _generateMonthYearHeader: function(Q, O, Y, S, W, Z, U, M) {
            var ad, N, ae, ab, R, aa, X, T, P = this._get(Q, "changeMonth"),
                af = this._get(Q, "changeYear"),
                ag = this._get(Q, "showMonthAfterYear"),
        ...
        _isInRange: function(Q, O) {
            var N, T, P = this._getMinMaxDate(Q, "min"),
                M = this._getMinMaxDate(Q, "max"),
                U = null,
                R = null,
                S = this._get(Q, "yearRange");
            if (S) {
                N = S.split(":");
    ...
    var f = y.widget("ui.slider", y.ui.mouse, {
        ...
        _createHandles: function() {
            var P, M, N = this.options,
                R = this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"),
                Q = "<span class='ui-slider-handle ui-state-default ui-corner-all' tabindex='0'></span>",
                O = [];
        ...
        _refreshValue: function() {
            var R, Q, U, S, V, P = this.options.range,
                O = this.options,
                T = this,
                N = (!this._animateOff) ? O.animate : false,
                M = {};
            if (this.options.values && this.options.values.length) {
     ...
     */
    (function(aa, P) {
        var W = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor",
            T = /^([\-+])=\s*(\d+\.?\d*)/,
            S = [{
        ...
        V.hsla.to = function(ad) {
            ...
            var ab = ad[0] / 255,
                ...
                ah = ad[2] / 255,
                aj = ad[3],
                ai = Math.max(ab, ag, ah),
                ae = Math.min(ab, ag, ah),
                ak = ai - ae,
                al = ai + ae,
                ac = al * 0.5,
                af, am;
        ...
        X(V, function(ac, ae) {
            ...
            Q.fn[ac] = function(al) {
                ...
                var ai, ak = aa.type(al),
                    ah = (ak === "array" || ak === "object") ? al : arguments,
                    aj = this[ab].slice();
                X(ad, function(am, ao) {
            ...
            X(ad, function(ah, ai) {
                ...
                Q.fn[ah] = function(am) {
                    var ao = aa.type(am),
                        al = (ah === "alpha" ? (this._hsla ? "hsla" : "rgba") : ac),
                        ak = this[al](),
                        an = ak[ai.idx],
                        aj;
                    if (ao === "undefined") {
    ...
    (function() {
        ...
        function P(U) {
            var R, Q, S = U.ownerDocument.defaultView ? U.ownerDocument.defaultView.getComputedStyle(U, null) : U.currentStyle,
                T = {};
        ...
        y.effects.animateClass = function(Q, R, U, T) {
            ...
            return this.queue(function() {
                var X = y(this),
                    V = X.attr("class") || "",
                    W, Y = S.children ? X.find("*").addBack() : X;
                Y = Y.map(function() {
                    var Z = y(this);
                    return {
                        el: Z,
    ...
    var J = y.effects.effect.blind = function(O, U) {
        var P = y(this),
            Y = /up|down|vertical/,
            X = /up|left|vertical|horizontal/,
            Z = ["position", "top", "bottom", "left", "right", "height", "width"],
            V = y.effects.setMode(P, O.mode || "hide"),
            aa = O.direction || "up",
            R = Y.test(aa),
            Q = R ? "height" : "width",
            W = R ? "top" : "left",
    ...
    var F = y.effects.effect.bounce = function(V, U) {
        var M = y(this),
            ...
            T = y.effects.setMode(M, V.mode || "effect"),
            S = T === "hide",
            ad = T === "show",
            ae = V.direction || "up",
            O = V.distance,
    ...
    var t = y.effects.effect.clip = function(P, S) {
        var Q = y(this),
            ...
            V = y.effects.setMode(Q, P.mode || "hide"),
            Y = V === "show",
            X = P.direction || "vertical",
            U = X === "vertical",
            Z = U ? "height" : "width",
            T = U ? "top" : "left",
            R = {},
    ...
    var l = y.effects.effect.drop = function(N, R) {
        var O = y(this),
            T = ["position", "top", "bottom", "left", "right", "opacity", "height", "width"],
            S = y.effects.setMode(O, N.mode || "hide"),
            V = S === "show",
            U = N.direction || "left",
            P = (U === "up" || U === "down") ? "top" : "left",
            W = (U === "up" || U === "left") ? "pos" : "neg",
            Q = {
                opacity: V ? 1 : 0
            },
            M;
    ...
    var E = y.effects.effect.explode = function(Z, Y) {
        var S = Z.pieces ? Math.round(Math.sqrt(Z.pieces)) : 3,
            N = S,
            M = y(this),
            U = y.effects.setMode(M, Z.mode || "hide"),
            ad = U === "show",
            Q = M.show().css("visibility", "hidden").offset(),
            aa = Math.ceil(M.outerWidth() / N),
            X = Math.ceil(M.outerHeight() / S),
            R = [],
            ac, ab, O, W, V, T;
    ...
    var v = y.effects.effect.fold = function(O, S) {
        var P = y(this),
            ...
            U = y.effects.setMode(P, O.mode || "hide"),
            aa = U === "show",
            V = U === "hide",
            ac = O.size || 15,
            W = /([0-9]+)%/.exec(ac),
    ...
    var a = y.effects.effect.size = function(V, U) {
        var Z, S, T, M = y(this),
            Y = ["position", "top", "bottom", "left", "right", "width", "height", "overflow", "opacity"],
            ...
            R = y.effects.setMode(M, V.mode || "effect"),
            aa = V.restore || R !== "effect",
            ae = V.scale || "both",
            ac = V.origin || ["middle", "center"],
            ad = M.css("position"),
            O = aa ? Y : X,
            P = {
                height: 0,
    ...
    var x = y.effects.effect.pulsate = function(M, Q) {
        var O = y(this),
            T = y.effects.setMode(O, M.mode || "show"),
            X = T === "show",
            U = T === "hide",
            Y = (X || T === "hide"),
            V = ((M.times || 5) * 2) + (Y ? 1 : 0),
    ...
    var r = y.effects.effect.shake = function(U, T) {
        var M = y(this),
            N = ["position", "top", "bottom", "left", "right", "height", "width"],
            S = y.effects.setMode(M, U.mode || "effect"),
            ac = U.direction || "left",
            O = U.distance || 20,
            R = U.times || 3,
            ad = R * 2 + 1,
            Y = Math.round(U.duration / ad),
            Q = (ac === "up" || ac === "down") ? "top" : "left",
            P = (ac === "up" || ac === "left"),
            ab = {},
            aa = {},
            Z = {},
    ...
    var q = y.effects.effect.slide = function(O, S) {
        var P = y(this),
            ...
            T = y.effects.setMode(P, O.mode || "show"),
            W = T === "show",
            V = O.direction || "left",
            Q = (V === "up" || V === "down") ? "top" : "left",
            N = (V === "up" || V === "left"),
            M, R = {};
        y.effects.save(P, U);
        P.show();
...
(function($) {
    ...
    jQuery.extend(Timepicker.prototype, {
        ...
        _newInst: function($input, opts) {
            ...
            overrides = {
                beforeShow: function(input, dp_inst) {
                    if (jQuery.isFunction(tp_inst._defaults.evnts.beforeShow)) {
                ...
                onClose: function(dateText, dp_inst) {
                    ...
                    if (jQuery.isFunction(tp_inst._defaults.evnts.onClose)) {
            ...
            tp_inst._defaults = jQuery.extend({}, this._defaults, inlineSettings, opts, overrides, {
                evnts: fns,
                timepicker: tp_inst
            });
            tp_inst.amNames = jQuery.map(tp_inst._defaults.amNames, function(val) {
                return val.toUpperCase()
            });
            tp_inst.pmNames = jQuery.map(tp_inst._defaults.pmNames, function(val) {
                return val.toUpperCase()
            });
            ...
            if (tzl > 0 && typeof timezoneList[0] !== "object") {
                for (; tzi < tzl; tzi++) {
                    ...
                    timezoneList[tzi] = {
                        value: tzv,
                        label: jQuery.timepicker.timezoneOffsetString(tzv, tp_inst.support.iso8601)
                    }
                }
            }
            tp_inst._defaults.timezoneList = timezoneList;
            tp_inst.timezone = tp_inst._defaults.timezone !== null ? jQuery.timepicker.timezoneOffsetNumber(tp_inst._defaults.timezone) : ((new Date()).getTimezoneOffset() * -1);
            ...
            if (tp_inst._defaults.altField) {
                tp_inst.$altInput = jQuery(tp_inst._defaults.altField);
        ...
        _parseTime: function(timeString, withDate) {
            if (!this.inst) {
                this.inst = jQuery.datepicker._getInst(this.$input[0])
            }
            if (withDate || !this._defaults.timeOnly) {
                ...
                try {
                    ...
                    jQuery.timepicker.log("Error parsing the date/time string: " + err + "\ndate/time string = " + timeString + "\ntimeFormat = " + this._defaults.timeFormat + "\ndateFormat = " + dp_dateFormat);
                    return false
                }
                return true
            } else {
        ...
        _injectTimePicker: function() {
            ...
            if ($dp.find("div.ui-timepicker-div").length === 0 && o.showTimepicker) {
                    ...
                    if (show && o[litem + "Grid"] > 0) {
                        ...
                        if (litem === "hour") {
                            for (var h = o[litem + "Min"]; h <= max[litem]; h += parseInt(o[litem + "Grid"], 10)) {
                                gridSize[litem]++;
                                var tmph = jQuery.datepicker.formatTime(this.support.ampm ? "hht" : "HH", {
                                    hour: h
                                }, o);
                ...
                jQuery.fn.append.apply(this.timezone_select, jQuery.map(o.timezoneList, function(val, idx) {
                    return jQuery("<option />").val(typeof val === "object" ? val.value : val).text(typeof val === "object" ? val.label : val)
                }));
        ...
        _onTimeChange: function() {
            ...
            var hasChanged = (hour !== parseInt(this.hour, 10) || minute !== parseInt(this.minute, 10) || second !== parseInt(this.second, 10) || millisec !== parseInt(this.millisec, 10) || microsec !== parseInt(this.microsec, 10) || (this.ampm.length > 0 && (hour < 12) !== (jQuery.inArray(this.ampm.toUpperCase(), this.amNames) !== -1)) || (this.timezone !== null && timezone !== this.timezone.toString()));
            if (hasChanged) {
                if (hour !== false) {
                    this.hour = hour
                }
            ...
            this.formattedTime = jQuery.datepicker.formatTime(o.timeFormat, this, o);
            if (this.$timeObj) {
                if (pickerTimeFormat === o.timeFormat) {
                    this.$timeObj.text(this.formattedTime + pickerTimeSuffix)
                } else {
                    this.$timeObj.text(jQuery.datepicker.formatTime(pickerTimeFormat, this, o) + pickerTimeSuffix)
                }
            }
        ...
        _updateDateTime: function(dp_inst) {
            ...
            var dtTmp = (dp_inst.currentYear > 0 ? new Date(dp_inst.currentYear, dp_inst.currentMonth, dp_inst.currentDay) : new Date(dp_inst.selectedYear, dp_inst.selectedMonth, dp_inst.selectedDay)),
                dt = jQuery.datepicker._daylightSavingAdjust(dtTmp),
                    ...
                    if (this.$altInput) {
                        ...
                        if (!this._defaults.timeOnly) {
                            if (this._defaults.altFormat) {
                                altFormattedDateTime = jQuery.datepicker.formatDate(this._defaults.altFormat, (dt === null ? new Date() : dt), formatCfg)
                            } else {
                        ...
                        if (this._defaults.altTimeFormat !== null) {
                            altFormattedDateTime += jQuery.datepicker.formatTime(this._defaults.altTimeFormat, this, this._defaults) + altTimeSuffix
                        } else {
        ...
        _onFocus: function() {
            if (!this.$input.val() && this._defaults.defaultValue) {
                ...
                var inst = jQuery.datepicker._getInst(this.$input.get(0)),
                ...
                create: function(tp_inst, obj, unit, val, min, max, step) {
                    ...
                    return obj.prop("slide", null).slider({
                        ...
                        slide: function(event, ui) {
                            tp_inst.control.value(tp_inst, jQuery(this), unit, rtl ? ui.value * -1 : ui.value);
                            tp_inst._onTimeChange()
                        },
            ...
            select: {
                create: function(tp_inst, obj, unit, val, min, max, step) {
                    ...
                    for (var i = min; i <= max; i += step) {
                        ...
                        if (unit === "hour") {
                            sel += jQuery.datepicker.formatTime(jQuery.trim(format.replace(/[^ht ]/ig, "")), {
                                hour: i
                            }, tp_inst._defaults)
                        } else {
    ...
    jQuery.fn.extend({
        ...
        datetimepicker: function(o) {
            ...
            if (typeof(o) === "string") {
                ...
                return this.each(function() {
                    var $t = jQuery(this);
                    $t.datepicker(jQuery.timepicker._newInst($t, o)._defaults)
                })
            }
        }
    });
    ...
    jQuery.datepicker.parseTime = function(timeFormat, timeString, options) {
        ...
        var strictParse = function(f, s, o) {
            var getPatternAmpm = function(amNames, pmNames) {
                ...
                markers = jQuery.map(markers, function(val) {
            ...
            if (treg) {
                if (order.t !== -1) {
                    if (treg[order.t] === undefined || treg[order.t].length === 0) {
                        ...
                        ampm = jQuery.inArray(treg[order.t].toUpperCase(), o.amNames) !== -1 ? "AM" : "PM";
                ...
                if (order.z !== -1 && treg[order.z] !== undefined) {
                    resTime.timezone = jQuery.timepicker.timezoneOffsetNumber(treg[order.z])
                }
                return resTime
            }
            return false
        ...
        var looseParse = function(f, s, o) {
            try {
                ...
                try {
                    ...
                    jQuery.timepicker.log("Unable to parse \ntimeString: " + s + "\ntimeFormat: " + f)
                }
            }
            return false
        };
    ...
    jQuery.datepicker.formatTime = function(format, time, options) {
        ...
        tmptime = tmptime.replace(/(?:HH?|hh?|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g, function(match) {
            switch (match) {
                ...
                case "z":
                    return jQuery.timepicker.timezoneOffsetString(time.timezone === null ? options.timezone : time.timezone, false);
                case "Z":
                    return jQuery.timepicker.timezoneOffsetString(time.timezone === null ? options.timezone : time.timezone, true);
                case "T":
    ...
    jQuery.datepicker._updateDatepicker = function(inst) {
        ...
        if (jQuery.datepicker._curInst && jQuery.datepicker._curInst !== inst && jQuery.datepicker._datepickerShowing && jQuery.datepicker._lastInput !== input) {
            return
        }
    ...
    jQuery.datepicker._base_updateAlternate = jQuery.datepicker._updateAlternate;
    jQuery.datepicker._updateAlternate = function(inst) {
        var tp_inst = this._get(inst, "timepicker");
        if (tp_inst) {
            ...
            if (altField) {
                var altFormat = tp_inst._defaults.altFormat || tp_inst._defaults.dateFormat,
                    ...
                    formatCfg = jQuery.datepicker._getFormatConfig(inst),
                    altFormattedDateTime = "",
                    altSeparator = tp_inst._defaults.altSeparator ? tp_inst._defaults.altSeparator : tp_inst._defaults.separator,
                    altTimeSuffix = tp_inst._defaults.altTimeSuffix ? tp_inst._defaults.altTimeSuffix : tp_inst._defaults.timeSuffix,
                    altTimeFormat = tp_inst._defaults.altTimeFormat !== null ? tp_inst._defaults.altTimeFormat : tp_inst._defaults.timeFormat;
                altFormattedDateTime += jQuery.datepicker.formatTime(altTimeFormat, tp_inst, tp_inst._defaults) + altTimeSuffix;
                if (!tp_inst._defaults.timeOnly && !tp_inst._defaults.altFieldTimeOnly && date !== null) {
                    if (tp_inst._defaults.altFormat) {
                        altFormattedDateTime = jQuery.datepicker.formatDate(tp_inst._defaults.altFormat, date, formatCfg) + altSeparator + altFormattedDateTime
                    } else {
                        altFormattedDateTime = tp_inst.formattedDate + altSeparator + altFormattedDateTime
                    }
                }
                jQuery(altField).val(inst.input.val() ? altFormattedDateTime : "")
            }
        } else {
            jQuery.datepicker._base_updateAlternate(inst)
        }
    };
    ...
    jQuery.datepicker._gotoToday = function(id) {
        ...
        jQuery(".ui-datepicker-today", $dp).click()
    };
    jQuery.datepicker._disableTimepickerDatepicker = function(target) {
        ...
        var tp_inst = this._get(inst, "timepicker");
        jQuery(target).datepicker("getDate");
        if (tp_inst) {
    ...
    jQuery.datepicker._setDateDatepicker = function(target, _date) {
        var inst = this._getInst(target);
        var date = _date;
        if (!inst) {
            return
        ...
        if (typeof(_date) === "string") {
            ...
            if (!date.getTime()) {
                ...
                date = jQuery(target).datepicker("getDate")
            }
        }
        var tp_inst = this._get(inst, "timepicker");
        var tp_date;
        ...
        if (tp_inst && tp_date) {
            ...
            date = jQuery.timepicker.timezoneAdjust(date, tp_inst.timezone);
            tp_date = jQuery.timepicker.timezoneAdjust(tp_date, tp_inst.timezone)
        }
        this._updateDatepicker(inst);
        this._base_setDateDatepicker.apply(this, arguments);
    ...
    jQuery.datepicker._getDateDatepicker = function(target, noDefault) {
        ...
        if (tp_inst) {
            ...
            if (date && tp_inst._parseTime(jQuery(target).val(), tp_inst.timeOnly)) {
    ...
    jQuery.datepicker.parseDate = function(format, value, settings) {
        ...
        try {
            ...
            if (err.indexOf(":") >= 0) {
                ...
                jQuery.timepicker.log("Error parsing the date string: " + err + "\ndate string = " + value + "\ndate format = " + format)
            } else {
                throw err
            }
        }
    ...
    jQuery.datepicker._optionDatepicker = function(target, name, value) {
        ...
        if (value === undefined) {
            return this._base_optionDatepicker.call(jQuery.datepicker, target, name)
        }
        return this._base_optionDatepicker.call(jQuery.datepicker, target, name_clone || name, value)
    };
    ...
    var computeEffectiveSetting = function(settings, property) {
        return settings && settings[property] ? settings[property] : jQuery.timepicker._defaults[property]
    };
    ...
    var parseDateTimeInternal = function(dateFormat, timeFormat, dateTimeString, dateSettings, timeSettings) {
        ...
        date = jQuery.datepicker._base_parseDate(dateFormat, parts.dateString, dateSettings);
        if (parts.timeString === "") {
            return {
                date: date
            }
        }
        parsedTime = jQuery.datepicker.parseTime(timeFormat, parts.timeString, timeSettings);
        if (!parsedTime) {
    ...
    jQuery.timepicker.timezoneOffsetString = function(tzMinutes, iso8601) {
    ...
    jQuery.timepicker.timezoneOffsetNumber = function(tzString) {
    ...
    jQuery.timepicker.timezoneAdjust = function(date, toTimezone) {
        var toTz = jQuery.timepicker.timezoneOffsetNumber(toTimezone);
        if (!isNaN(toTz)) {
            date.setMinutes(date.getMinutes() + -date.getTimezoneOffset() - toTz)
        }
        return date
    };
    jQuery.timepicker.timeRange = function(startTime, endTime, options) {
        return jQuery.timepicker.handleRange("timepicker", startTime, endTime, options)
    };
    jQuery.timepicker.datetimeRange = function(startTime, endTime, options) {
        jQuery.timepicker.handleRange("datetimepicker", startTime, endTime, options)
    };
    jQuery.timepicker.dateRange = function(startTime, endTime, options) {
        jQuery.timepicker.handleRange("datepicker", startTime, endTime, options)
    };
    jQuery.timepicker.handleRange = function(method, startTime, endTime, options) {
        ...
        jQuery.fn[method].call(startTime, jQuery.extend({
            timeOnly: timeOnly,
            onClose: function(dateText, inst) {
                checkDates(jQuery(this), endTime)
            },
            onSelect: function(selectedDateTime) {
                selected(jQuery(this), endTime, "minDate")
            }
        }, options, options.start));
        jQuery.fn[method].call(endTime, jQuery.extend({
            timeOnly: timeOnly,
            onClose: function(dateText, inst) {
                checkDates(jQuery(this), startTime)
            },
            onSelect: function(selectedDateTime) {
                selected(jQuery(this), startTime, "maxDate")
            }
        }, options, options.end));
        checkDates(startTime, endTime);
        selected(startTime, endTime, "minDate");
        selected(endTime, startTime, "maxDate");
        return jQuery([startTime.get(0), endTime.get(0)])
    };
    jQuery.timepicker.log = function(err) {};
    jQuery.timepicker._util = {
    ...
    jQuery.timepicker.version = "1.4.5"
})(jQuery);
/*
        ...
        mask: function(q, j) {
            ...
            return j = e.extend({
                    ...
                    if (!(0 > L)) {
                        for (K = L, J = D(I); l > K; K++) {
                            if (h[K]) {
                                ...
                                w[K] = w[J], w[J] = E(J), J = D(J)
                            }
                        }
                        C(), F.caret(Math.max(p, L))
                    }
                }
                ...
                function s(M) {
                    ...
                    for (K = M, L = E(M); l > K; K++) {
                        if (h[K]) {
                            if (I = D(K), J = w[K], w[K] = L, !(l > I && h[I].test(J))) {
                                break
                            }
                            L = J
                        }
                ...
                function z(L) {
                    if (!F.prop("readonly")) {
                        ...
                        o = F.val(), 8 === J || 46 === J || c && 127 === J ? (M = F.caret(), K = M.begin, I = M.end, I - K === 0 && (K = 46 !== J ? y(K) : I = D(K - 1), I = 46 === J ? D(I) : I), t(K, I), v(K, I - 1), L.preventDefault()) : 13 === J ? x.call(this, L) : 27 === J && (F.val(H), F.caret(0, u()), L.preventDefault())
                    }
                }

                function G(M) {
                    if (!F.prop("readonly")) {
                        var L, O, K, I = M.which || M.keyCode,
                            N = F.caret();
                        if (!(M.ctrlKey || M.altKey || M.metaKey || 32 > I) && I && 13 !== I) {
                            if (N.end - N.begin !== 0 && (t(N.begin, N.end), v(N.begin, N.end - 1)), L = D(N.begin - 1), l > L && (O = String.fromCharCode(I), h[L].test(O))) {
                                if (s(L), w[L] = O, C(), K = D(L), b) {
                                    var J = function() {
                ...
                function u(J) {
                    ...
                    for (I = 0, M = 0; l > I; I++) {
                        if (h[I]) {
                            ...
                            w[I] === L.charAt(M) && M++, i > I && (K = I)
                        }
                    }
                    return J ? C() : i > K + 1 ? j.autoclear || w.join("") === B ? (F.val() && F.val(""), t(0, l)) : C() : (C(), F.val(F.val().substring(0, K + 1))), i ? I : p
                }
                var F = e(this),
                ...
                F.data(e.mask.dataName, function() {
                    ...
                    if (!F.prop("readonly")) {
                        clearTimeout(f);
                        var I;
                        H = F.val(), I = u(), f = setTimeout(function() {
                            C(), I == q.replace("?", "").length ? F.caret(0, I) : F.caret(I)
                        }, 10)
                    }
                ...
                }), a && b && F.off("input.mask").on("input.mask", A), u()
            })
        }
    })
});
...
jQuery(function() {
    var a = {
        ...
        simulator: jQuery('<div id="textarea_simulator"/>').css({
            position: "absolute",
            top: 0,
            left: 0,
            visibility: "hidden"
        ...
        getCaretPosition: function() {
            var c = a,
                ...
                g = n[0],
                d = n.offset();
            if (jQuery.browser.msie && document.selection && document.selection.createRange) {
                g.focus();
                var h = document.selection.createRange();
                jQuery("#hskeywords").val(g.scrollTop);
                return {
            ...
            c.simulator.empty();
            jQuery.each(c.primaryStyles, function(p, q) {
                n.cloneStyle(c.simulator, q)
            });
            c.simulator.css(jQuery.extend({
                width: n.width(),
                height: n.height()
            }, c.specificStyle));
            var l = n.val(),
            ...
            var f = l.substring(0, e),
                m = l.substring(e);
            var j = jQuery('<span class="before"/>').html(c.toHtml(f)),
                o = jQuery('<span class="focus"/>'),
                b = jQuery('<span class="after"/>').html(c.toHtml(m));
            c.simulator.append(j).append(o).append(b);
            var i = o.offset(),
                k = c.simulator.offset();
            return {
                top: i.top - k.top - g.scrollTop + (jQuery.browser.mozilla ? 0 : parseInt(n.getComputedStyle("fontSize"))),
    ...
    jQuery.fn.extend({
        getComputedStyle: function(c) {
            ...
            var d = this[0];
            var b = this.css(c);
            b = b || (jQuery.browser.msie ? d.currentStyle[c] : document.defaultView.getComputedStyle(d, null)[c]);
            return b
        },
