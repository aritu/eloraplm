 ...
 *
 */
public class CsvEloraExporter extends EloraExporter {

    private CSVOptions csvOptions;

    public CsvEloraExporter(ExporterOptions options) {
        ...
        if (options != null) {
            if (options instanceof CSVOptions) {
                ...
                throw new IllegalArgumentException(
                        "Options must be an instance of CSVOptions.");
            }
        }
    }
    ...
    protected void addColumnFacets(StringBuilder builder, DataTable table,
            ColumnType columnType) throws IOException {
    ...
    protected void configureResponse(ExternalContext externalContext,
            String filename, String encodingType) {
        externalContext.setResponseContentType(
                "text/csv; charset=" + encodingType);
    ...
    protected void addColumnValues(StringBuilder builder,
            List<UIColumn> columns) throws IOException {
    ...
    protected void addColumnValue(StringBuilder builder, UIComponent component)
            throws IOException {
    ...
    protected void addColumnValue(StringBuilder builder, String value)
            throws IOException {
        value = (value == null) ? ""
                : value.replace(csvOptions.getQuoteString(),
                        csvOptions.getDoubleQuoteString());

        builder.append(csvOptions.getQuoteChar()).append(value).append(
                csvOptions.getQuoteChar());
    }

    protected void addColumnValue(StringBuilder builder,
            List<UIComponent> components, UIColumn column) throws IOException {
