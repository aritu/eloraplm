 ...
 *
 */
public class ExcelEloraExporter extends EloraExporter {
    ...
    @Override
    public void export(FacesContext context, String filename,
    ...
    public void export(FacesContext context, List<String> clientIds,
            String filename, boolean pageOnly, boolean selectionOnly,
            String encodingType, MethodExpression preProcessor,
            MethodExpression postProcessor, ExporterOptions options,
            MethodExpression onTableRender) throws IOException {
        ...
        VisitContext visitContext = VisitContext.createVisitContext(context,
                clientIds, null);
        VisitCallback visitCallback = new ExcelEloraExportVisitCallback(this,
                wb, pageOnly, selectionOnly);
    ...
    protected void addColumnFacets(DataTable table, Sheet sheet,
            EloraExporter.ColumnType columnType) {
        int sheetRowIndex = columnType.equals(EloraExporter.ColumnType.HEADER)
                ? 0
    ...
    protected void addColumnValue(Row row, List<UIComponent> components,
        ...
        if (column.getExportFunction() != null) {
            cell.setCellValue(createRichTextString(
                    exportColumnByFunction(context, column)));
        } else {
    ...
    public void exportTable(FacesContext context, DataTable table, Sheet sheet,
            boolean pageOnly, boolean selectionOnly) {
        addColumnFacets(table, sheet, EloraExporter.ColumnType.HEADER);
        ...
        if (table.hasFooterColumn()) {
            addColumnFacets(table, sheet, EloraExporter.ColumnType.FOOTER);
        }

        table.setRowIndex(-1);
    }

    protected void applyOptions(Workbook wb, DataTable table, Sheet sheet,
            ExporterOptions options) {
        facetStyle = wb.createCellStyle();
        facetStyle.setAlignment(CellStyle.ALIGN_CENTER);
        facetStyle.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
    ...
    protected void applyFacetOptions(Workbook wb, ExporterOptions options,
        ...
        if (options != null) {
            ...
            if (facetBackground != null) {
                ...
                HSSFColor backgroundColor = palette.findSimilarColor(
                        color.getRed(), color.getGreen(), color.getBlue());
                ((HSSFCellStyle) facetStyle).setFillForegroundColor(
                        backgroundColor.getIndex());
            ...
            if (facetFontColor != null) {
                ...
                HSSFColor facetColor = palette.findSimilarColor(color.getRed(),
    ...
    protected void applyCellOptions(Workbook wb, ExporterOptions options,
        ...
        if (options != null) {
            ...
            if (cellFontColor != null) {
                ...
                HSSFColor cellColor = palette.findSimilarColor(color.getRed(),
                        color.getGreen(), color.getBlue());
