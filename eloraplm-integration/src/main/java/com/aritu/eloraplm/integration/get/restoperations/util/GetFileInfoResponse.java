...
public class GetFileInfoResponse extends EloraGeneralResponse {

    private static final Log log = LogFactory.getLog(GetFileInfoResponse.class);

    List<GetFileInfoResponseDoc> documents;
    ...
    public GetFileInfoResponse() {
        super();
        documents = new ArrayList<GetFileInfoResponseDoc>();
    }

    public List<GetFileInfoResponseDoc> getDocuments() {
        return documents;
    }

    public void addDocument(GetFileInfoResponseDoc document) {
    ...
    /**
     * Converts GetFileInfoResponse to a JSON formatted String.
     */
    @Override
