 ...
 *
 */
@JsonPropertyOrder({ "result", "errorMessage", "vocabulary" })
public class SyncVocabularyResponse extends EloraGeneralResponse {

    private static final Log log = LogFactory.getLog(
            SyncVocabularyResponse.class);
     ...
     */
    public SyncVocabularyResponse() {
        super();
        vocabulary = new VocabularyInfo();
    }

    public VocabularyInfo getVocabulary() {
        return vocabulary;
    }

    public void setVocabulary(VocabularyInfo vocabulary) {
        this.vocabulary = vocabulary;
    }

    /**
     * Converts SyncVocabularyResponse to a JSON formatted String.
     */
    @Override
