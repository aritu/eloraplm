...
public class GetUserWorkspacesResponse extends EloraGeneralResponse {

    private static final Log log = LogFactory.getLog(GetWorkspacesResponseDoc.class);

    List<GetUserWorkspacesResponseDoc> workspaces;

    public GetUserWorkspacesResponse() {
        super();
        workspaces = new ArrayList<GetUserWorkspacesResponseDoc>();
    }

    public List<GetUserWorkspacesResponseDoc> getWorkspaces() {
        return workspaces;
    }

    public void addDocument(GetUserWorkspacesResponseDoc document) {
