...
public class SaveResponse extends EloraGeneralResponse {

    private static final Log log = LogFactory.getLog(SaveResponse.class);

    List<SaveResponseDoc> documents;
    ...
    public SaveResponse() {
        super();
        documents = new ArrayList<SaveResponseDoc>();
    }

    public List<SaveResponseDoc> getDocuments() {
        return documents;
    }

    public void addDocument(SaveResponseDoc document) {
    ...
    /**
     * Converts SaveResponse to a JSON formatted String.
     */
    @Override
