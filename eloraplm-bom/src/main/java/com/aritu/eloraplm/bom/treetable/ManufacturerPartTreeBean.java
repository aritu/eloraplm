...
@Name("manufacturerPartTreeBean")
@Scope(ScopeType.CONVERSATION)
@Install(precedence = APPLICATION)
@AutomaticDocumentBasedInvalidation
public class ManufacturerPartTreeBean extends EditableRelationTreeBean
        implements Serializable {
    private static final long serialVersionUID = 1L;

    private static final Log log = LogFactory.getLog(
            ManufacturerPartTreeBean.class);
    ...
    public ManufacturerPartTreeBean() throws EloraException {
    ...
    @Override
    @Factory(value = "manufacturerPartRoot", scope = ScopeType.EVENT)
