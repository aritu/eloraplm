...
@Name("bomItemInverseTreeBean")
@Scope(ScopeType.CONVERSATION)
@Install(precedence = APPLICATION)
@AutomaticDocumentBasedInvalidation
public class BomItemInverseTreeBean extends EditableRelationTreeBean
        implements Serializable {
    private static final long serialVersionUID = 1L;

    private static final Log log = LogFactory.getLog(
            BomItemInverseTreeBean.class);
    ...
    public BomItemInverseTreeBean() throws EloraException {
    ...
    @Override
    @Factory(value = "bomItemInverseRoot", scope = ScopeType.EVENT)
