 ...
 *
 */
public class BomCompositionListNodeService extends BomListNodeService implements
        NodeManager {

    public BomCompositionListNodeService(CoreSession session, String bomListId) {
        super(session);
