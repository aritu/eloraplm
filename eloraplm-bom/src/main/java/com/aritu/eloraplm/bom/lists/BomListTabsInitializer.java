...
@Startup
public class BomListTabsInitializer implements Serializable {

    private static final long serialVersionUID = 1L;

    public static final Log log = LogFactory.getLog(
            BomListTabsInitializer.class);

    public static BomListTabsInitializer instance() {
        if (!Contexts.isSessionContextActive()) {
            return null;
        }
        return (BomListTabsInitializer) Component.getInstance(
                BomListTabsInitializer.class, ScopeType.SESSION);
    }
