 ...
 *
 */
public class BomDocumentsNodeService extends RelationNodeService
        implements NodeManager {

    public BomDocumentsNodeService(CoreSession session,
    ...
    private void loadPredicates() {
        ...
        directRelationsList.add(EloraRelationConstants.BOM_HAS_DOCUMENT);
