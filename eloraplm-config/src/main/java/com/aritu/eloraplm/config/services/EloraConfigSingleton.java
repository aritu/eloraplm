...
public class EloraConfigSingleton {

    private EloraConfigSingleton() {
    }

    private static class EloraConfigSingletonHelper {
        private static final EloraConfigSingleton INSTANCE = new EloraConfigSingleton();
    }

    public static EloraConfigSingleton getInstance() {
        return EloraConfigSingletonHelper.INSTANCE;
    }
    ...
    public EloraConfigRow getConfigProperties(String vocabulary, String key,
        ...
        Session dirSession = getDirectoryService().open(vocabulary);
        try {
