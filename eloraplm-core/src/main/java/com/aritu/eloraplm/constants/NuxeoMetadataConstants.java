...
public final class NuxeoMetadataConstants {

    public static final String NX_DC_DESCRIPTION = "dc:description";

    public static final String NX_DC_RIGHTS = "dc:rights";
    ...
    public static final String NX_UID_MAJOR_VERSION = "uid:major_version";

    public static final String NX_UID_MINOR_VERSION = "uid:minor_version";

    public static final String NX_ECM_VERSION_SERIES_ID = "ecm:versionSeriesId";

    public static final String NX_ECM_VERSION_LABEL = "ecm:versionLabel";
