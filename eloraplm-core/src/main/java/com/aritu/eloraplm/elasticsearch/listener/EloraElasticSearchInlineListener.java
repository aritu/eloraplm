 ...
 */
package com.aritu.eloraplm.elasticsearch.listener;
...
import com.aritu.eloraplm.elasticsearch.commands.EloraIndexingCommandsStacker;

/**
 * Synchronous Event listener used to record indexing command, submitted after
 * commit completion.
 *
 * Elora changes: extends EloraIndexingCommandsStacker instead of Nuxeo's
 * standard.
 *
 * @author aritu
 *
 */
public class EloraElasticSearchInlineListener extends
        EloraIndexingCommandsStacker implements EventListener, Synchronization {
